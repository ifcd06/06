  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0 mt-2 text-center">
        <a href="index.php?modulo=crearclientes" class="text-center">Registro nuevo usuario</a><br>
        <a href="../index.php" class="text-danger text-center">Iniciar Sesión como admin</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
