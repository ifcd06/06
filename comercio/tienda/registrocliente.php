      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-8">
            ...
            //comprobar si la query encuentra alguna linea en el resultado, de esta forma sabemos si existe el usuario o no
                ...
                <?php }
                    ...
                    <?php }
                        ...
                        if ($resultset) {
                        print "<meta http-equiv=\"refresh\" content=\"0; url=./panel.php?modulo=clientes&mensaje=Cliente creado exitosamente, ya puede iniciar sesión\"/>  ";
                        }
                        else { ?>
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="get" action="index.php?modulo=registrocliente">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <a class="btn btn-danger" href="panel.php?modulo=" role="button">Cancelar</a>
                </div>
              </form>
            </div>
            <!-- /.card-body -->
