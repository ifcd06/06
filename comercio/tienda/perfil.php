...
if (isset($_REQUEST["actualizar"])) {
  ...
  if ($resultset) {
    ...
    print "<meta http-equiv=\"refresh\" content=\"0; url=index.php?mensaje=$nombre el perfil se ha actualizado exitosamente\" />  ";
  } else { ?>
    <div class="alert alert-danger float-right" role="alert">
      <strong>Atención! no se ha Modificado el perfil, pongase en contacto con nosotros.</strong>
    </div>
<?php }
}
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="get" action="index.php">
                ...
                <div class="form-group">
                <input type="hidden" name="modulo" value="actualizar">
