        ...
        <ul class="navbar-nav ml-auto">
          ...
          <form class="form-inline ml-3" action="index.php">
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar bg-gray" type="search" placeholder="Buscar producto" aria-label="Search" name="nombre" value="<?php print $_REQUEST["nombre"]??"" ?>">
